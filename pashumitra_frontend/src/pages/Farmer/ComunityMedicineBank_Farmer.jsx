...
export default function CommunityMedicineBank() {
  ...
  const medicines = [
    ...
    },
    {
      ...
      quantity: "2 packets",
      expiry: "2024-12-20",
      donor: "Sunita Dairy Farm",
      location: "Village B, 5km away",
      status: "Good",
    ...
    },
    {
      ...
      quantity: "30 tablets",
      expiry: "2025-03-10",
      donor: "Cooperative Society",
      location: "Main Market, 2km away",
      status: "New/Unopened",
      statusColor: "bg-green-100 text-green-800",
    },
  ]
              ...
              {medicines.map((medicine, index) => (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${medicine.statusColor}`}>
                      {medicine.status}
                    </span>
                  </div>
