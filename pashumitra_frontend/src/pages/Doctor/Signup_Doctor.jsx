...
const SignupPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("http://localhost:5000/api/users/signup/doctor", {
        method: "POST",
      ...
      <div className="w-full max-w-3xl bg-white rounded-3xl shadow-xl p-8 md:p-12">
        ...
        <div className="mb-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800">
            Create your <span className="text-blue-600">PashuMitra</span> Doctor Account
          </h2>
          <p className="text-gray-500 mt-2 text-sm">
            Join as a doctor to offer animal healthcare services
          </p>
        </div>
